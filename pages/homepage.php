...
<main class="container mt-5">
    ...
    <div class="text-center mb-4">
        <img src="../assets/images/logo.png" alt="Inventory Management System" class="img-fluid" style="max-width: 200px;">
    </div>

    <h2 class="text-center">Welcome to the Inventory Management System</h2>
    <h4 class="text-center">Browse Our Products</h4>
